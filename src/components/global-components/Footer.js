					...
					<div className="row">
						...
						<div className="col-md-8 text-md-right mt-3 mt-md-0">
							<ul className="social-area">
								<li><a href="https://www.facebook.com/Sunsetrealtypy" target="_blank"><i className="fab fa-facebook-f" aria-hidden="true" /></a></li>
								<li><a href="https://www.twitter.com/#/" target="_blank"><i className="fab fa-twitter" aria-hidden="true"  /></a></li>
								<li><a href="https://www.instagram.com/#/" target="_blank"><i className="fab fa-instagram" aria-hidden="true" /></a></li>
				...
				<div className="container">
					<div className="row">
						<div className="col-md-7 align-self-center">
							<p>©2021, Copyright By Moochsoft. All Rights Reserved</p>
						</div>
